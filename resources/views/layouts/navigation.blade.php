<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur-md border-b border-slate-100 sticky top-0 z-40">
                ...
                <div class="hidden space-x-1 sm:flex items-center">
                    ...
                    @can('admin')
                        <a href="{{ route('admin.dashboard') }}" 
                           class="px-4 py-2 rounded-xl text-sm font-bold transition-all duration-300 {{ request()->routeIs('admin.*') ? 'bg-primary-50 text-primary-600' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
                            {{ __('Admin Panel') }}
                        </a>
                    @endcan
                </div>
    ...
    <div x-show="open" 
        ...
        <div class="pt-4 pb-3 space-y-1 px-4">
            ...
            @can('admin')
                <a href="{{ route('admin.dashboard') }}" 
                   class="flex items-center px-4 py-3 rounded-xl text-base font-bold transition-all {{ request()->routeIs('admin.*') ? 'bg-primary-50 text-primary-600' : 'text-slate-600 hover:bg-slate-50' }}">
